...
const Signup = () => {
  const { createUser, updateUser, googleLoginProvider } =
  ...
  const saveUser = (name, email, category) => {
    ...
    fetch("https://bike-resale-server-chi.vercel.app/users", {
      method: "POST",
      headers: {
    ...
    <div className="h-[800px]  flex justify-center items-center">
      <div className="w-96 p-7">
        <h1 className="text-3xl text-center font-bold">
          <FaMotorcycle className="h-40 w-80 text-black	"></FaMotorcycle>Sign Up
        </h1>
